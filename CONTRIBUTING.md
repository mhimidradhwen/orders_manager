...
We expect all contributors to the Order Manager project to follow our [code of conduct](CODE_OF_CONDUCT.md). Please make sure you understand and agree to these guidelines before contributing.
